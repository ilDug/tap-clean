...
// BUTTONS
const int RUN_BTN_PIN = A1; // pin del bottone RUN
const int PRG_BTN_PIN = A2; // pin del bottone PRG
const int LVL_POT_PIN = A3; // pin del potenziometro LVL

// SCALE (BILANCIA)
const int SCALE_DATA_PIN = 12;  // pin dei dati della bilancia
const int SCALE_CLOCK_PIN = A0; // pin del clock della bilancia
